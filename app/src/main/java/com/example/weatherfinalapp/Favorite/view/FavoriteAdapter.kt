...
class FavoriteAdapter(private val context: Context , private val listener : OnFavClickListener): RecyclerView.Adapter<FavoriteAdapter.FavViewHolder>()   {
    private var listOfFavLocations= listOf<FavoriteLocation>()


    fun setList(newList: List<FavoriteLocation>){
        listOfFavLocations = newList
        notifyDataSetChanged()
    }

    override fun getItemCount(): Int {
        return listOfFavLocations.size
    }
    ...
    override fun onBindViewHolder(holder: FavViewHolder, position: Int) {
        val locationItem = listOfFavLocations[position]
